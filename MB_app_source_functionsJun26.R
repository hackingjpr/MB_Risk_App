...
#generate_survival_figure_mrt <- function(new.sample.meta.score, indexRow) {
#   
#   mrt13.models <- readRDS(file = "./AppExtraFiles/mrt13.models.rds")
#   train.fit.radio <- readRDS(file = "./AppExtraFiles/mrt13.train.fit.radio.rds")
#   df.cat.mrt.meta.n13 <- readRDS(file = "./AppExtraFiles/df.cat.mrt.meta.n13.rds")
#   
#   summary(survfit(mrt13.models$meta.comb, data.frame(metacpg=df.cat.mrt.meta.n13$metacpg)), time = 730) -> x
#   
#   df2 <- data.frame(pred = df.cat.mrt.meta.n13$metacpg,
